...
1. Create base classes
    1. [Token](/../../issues/16)
    2. [Subcommand (inherits from Token)](/../../issues/17)
    3. [Operator (inherits from Token, can have Token* children)](/../../issues/18)
    4. [CommandTree (nodes are Token*)](/../../issues/19)
2. Design AND TEST functions (any order):
    1. rshell
        1. [string userInput()](/../../issues/20) [test](/../../issues/28)
    2. parser
        1. [string filterComments(string)](/../../issues/21) [test](/../../issues/29)
        2. [vector<string> splitSpaces(string)](/../../issues/22) [test](/../../issues/30)
        3. [vector<Token*> tokenize(vector<string>)](/../../issues/23) [test](/../../issues/31)
        4. [CommandTree constructExpressionTree(vector<Token*>)](/../../issues/24) [test](/../../issues/32)
    3. executor
        1. [Subcommand expandAliases(Subcommand)](/../../issues/25) [test](/../../issues/33)
        2. [bool checkBuiltin(Subcommand)](/../../issues/26) [test](/../../issues/34)
        3. [int executeSubcommand(Subcommand)](/../../issues/27) [test](/../../issues/35)
3. Combine functions from previous step and make integration tests (any order):
    ...
    2. [CommandTree parser(string)](/../../issues/37)
    ...
    3. [int executor(CommandTree)](/../../issues/38)
...
4. [Do a complete integration test (rshell → parser → executor)](/../../issues/39)
